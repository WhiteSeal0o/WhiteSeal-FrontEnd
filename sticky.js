...
function myFunction() {
    ...
    if (wScroll >= $('.part4').offset().top - 100) {
        nav[0].style.color = "#e9696e";
        nav[1].style.color = "#e9696e";
    }
    if (wScroll >= $('.part5').offset().top - 100) {
    ...
    if (window.innerWidth >= 750) {
        ...
        document.getElementsByClassName("describle")[0].style.transform = 'translateY(' + (+window.pageYOffset / 16) + '%)';
        document.getElementById("new-rl").style.transform = 'translate(' + (window.pageYOffset / 40) + '%,' + (window.pageYOffset / 15) + '%)';
    }
